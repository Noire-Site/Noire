        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none text-sm bg-brand-offwhite dark:bg-brand-black border border-brand-gray-light dark:border-[#2A2A2A] pl-4 pr-8 py-2 rounded-pill focus:outline-none focus:ring-2 focus:ring-brand-orange cursor-pointer"
            ...
            <svg className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-brand-gray" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
